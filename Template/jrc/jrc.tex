...
%% images {{{
% footer
\pgfdeclareimage[height=5.5mm]{footer}{graphics/footer}

% header
\pgfdeclareimage[width=0.1575\paperwidth]{header}{graphics/header}

% headerT
\pgfdeclareimage[width=0.1575\paperwidth]{headerT}{graphics/headerT}
...
\newcommand{\footlinetext}{\mydate\today}
