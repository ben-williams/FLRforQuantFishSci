...
% set the title
\parbox[top][2.8cm][c]{\textwidth}{\begin{center} \color{white}\LARGE \textbf{\inserttitle}  \\ \vspace{10pt} \color{black!30}\small \insertsubtitle \end{center}}
...
{\flushleft \color{white} \textbf{\insertauthor} \\ \vspace{5pt} \insertinstitute }
\end{minipage}
}
%%% end title page
